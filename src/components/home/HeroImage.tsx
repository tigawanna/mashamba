...
// import SmallLand from '../../assets/land-mobile.webp';
...
<Link 
href={'listings'}
className='flex gap-2 w-fit items-center justify-center  border-b-4 border-b-slate-400 text-blue-900 text-3xl font-bold p-2 mt-2 '>
    Browse catalog <TheIcon Icon={BsArrowRight} iconstyle='hover:scale-105'/>
</Link>
</div>
</div>
