...
function I(e, t, r) {
  ...
  if (t != null)
    ...
    t))
      P.call(t, o) && !x.hasOwnProperty(o) && (n[o] = t[o]);
  ...
  if (e && e.defaultProps)
    for (o in ((f = e.defaultProps), f)) n[o] === void 0 && (n[o] = f[o]);
  return { $$typeof: y, type: e, key: i, ref: s, props: n, _owner: g.current };
}
function W(e, t) {
  return {
    $$typeof: y,
...
function _(e, t, r, o, n) {
  ...
  else if (((c = G(e)), typeof c == "function"))
    for (e = c.call(e), f = 0; !(i = e.next()).done; )
      (i = i.value), (c = o + m(i, f++)), (s += _(i, t, r, c, n));
  else if (i === "object")
    throw (
      ((t = String(e)),
      Error(
...
u.StrictMode = V;
u.Suspense = z;
u.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Q;
u.cloneElement = function (e, t, r) {
  ...
  if (t != null) {
    if (
      (t.ref !== void 0 && ((i = t.ref), (s = g.current)),
  ...
  return { $$typeof: y, type: e.type, key: n, ref: i, props: o, _owner: s };
};
...
const Y = A(v),
  ee = T({ __proto__: null, default: Y }, [v]);
export { ee as R, Y as a, A as b, X as c, Z as g, v as r };
