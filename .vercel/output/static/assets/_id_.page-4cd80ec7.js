import { b as y, a as w, C as b, _ as v, p as E } from "./client-c8939a82.js";
import { a } from "./jsx-runtime-6a3157d9.js";
import { r as n } from "./index-e76fa941.js";
import { c as S } from "./concatErrors-9ce0d561.js";
import { u as x } from "./useGeoLocation-7b1cbf9f.js";
const L = n.lazy(() =>
  v(
...
function z({ params: l }) {
  const { position: o } = x(),
    [m, i] = n.useState({ name: "", message: "" }),
    { data: r, refetch: k } = y(["1", 0, [l]], {
      refetchOnWindowFocus: !0,
      refetchOnReconnect: !0,
    });
  if (!r) return a("div", { children: "Loading..." });
  const u = r.items[0],
    f = {
      location: "",
      longitude: o.lng,
  ...
  async function g(e) {
    ...
    e.images &&
      ...
      e.amenities && t.append("amenities", JSON.stringify(e.amenities));
    for (const s in e) !h.includes(s) && e[s] !== "" && t.append(s, e[s]);
    return await E.collection("listings").create(t);
  }
  const _ = w((e) => g(e), {
    onSuccess: () => {
      i({ name: "", message: "" });
